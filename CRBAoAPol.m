function Qcrb = CRBAoAPol(egain,SNRdB,lam,Rarray,Euler,M,...
    TrueAzEl,TruePol)
...
% Qcrb      -- 4 x 4 x nsnr the minimal covariance matrix for the four 
%              real parameters:  phi = [az, el, p1, p2] all in deg^2
%              Local horizontal is the 
%              axis orthogonal to elevation, dAz = dHoriz / sin(El)
%              E{ dphi * dphi' } >= Qcrb
